...
세 명이 한 팀이었다. 컴퓨터정보공학부 둘에 경영학부 하나. 첫날 점심 지나서 단톡을 파고 거기서 일을 나눴다.

처음 생각한 건 지금이랑 좀 달랐다. 캠퍼스 빈자리를 보여 주고 콘센트 자리를 실시간으로 따라가는 기능이 들어 있었는데, 첫날 오후에 팀원이 그건 빼자고 했다. 실제 데이터를 구할 방법이 없었기 때문이다. 대신 지도를 더 구체적으로 만들고, 한/영 전환, 어두운 화면, 운동장 예약을 넣자고 정리해 줬고 그대로 갔다. 강의실 예약도 얘기가 나왔는데 거기까지는 못 했다.

편의시설 탭은 경영학부 팀원이 시작했다. 단과대학 라운지 일곱 곳의 이름, 건물, 운영시간을 직접 찾아서 단톡에 올려 줬다. 인문대 ACE 라운지는 인문 1관 1층에 평일 9시부터 18시, 이런 식으로. 그게 편의시설 데이터의 첫 줄이 됐고 나중에 41곳까지 늘었다. 밤에는 지도 화면을 보다가 건물 이름이 요즘 부르는 이름이랑 다르다고 짚어 줬다. 지도 데이터에는 법과대, 행정대로 나오는데 지금은 공공인재대학이다. 그렇게 찾은 게 18쌍이다.

참고할 지도 캡처를 모아 준 것도 팀원이다. 밤 11시 40분쯤 거의 다 됐으니 에러를 찾아 달라는 말이 단톡에 올라왔고, 그때부터 나는 폰이랑 태블릿으로 버튼을 하나씩 눌러 보면서 안 되는 걸 찾았다. 계획이랑 진행 상황은 노션 한 페이지에 적어서 같이 봤다.
