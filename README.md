...
세 명이 한 팀이었다. 컴퓨터정보공학부 문지훈, 김성규, 경영학부 Hay Mann Moe. 첫날 점심 지나서 성규가 단톡을 팠고 거기서 일을 나눴다.

처음 생각한 건 지금이랑 좀 달랐다. 캠퍼스 빈자리를 보여 주고 콘센트 자리를 실시간으로 따라가는 기능이 들어 있었는데, 첫날 오후에 성규가 그건 빼자고 했다. 실제 데이터를 구할 방법이 없었기 때문이다. 대신 지도를 더 구체적으로 만들고, 한/영 전환, 어두운 화면, 운동장 예약을 넣자고 정리해 줬고 그대로 갔다. 강의실 예약도 얘기가 나왔는데 거기까지는 못 했다.
...
참고할 지도 캡처를 모아 준 것도 성규다. 밤 11시 40분쯤 성규가 거의 다 됐으니 에러를 찾아 달라고 단톡에 올렸고, 그때부터 나는 폰이랑 태블릿으로 버튼을 하나씩 눌러 보면서 안 되는 걸 찾았다. 계획이랑 진행 상황은 노션 한 페이지에 적어서 같이 봤다.
